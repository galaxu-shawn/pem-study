...
heatmap.update_heatmap_time_domain(tx_mode=ant_device_tx.modes[mode_name],
                                   ...
                                   end_animation_after_time=0.2e-6,
                                   use_slider_widget=False,
                                   loop_animation=False)
# use_slider_widget = False will create a video, use_slider_widget = True will create a slider bar
if export_debug:
