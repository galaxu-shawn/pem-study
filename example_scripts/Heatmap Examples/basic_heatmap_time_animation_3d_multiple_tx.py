...
tx2_pos = [1, 0.07, 2] # which will be relative to ego vehicle (rear center axle)
tx3_pos = [1, -0.07, 2] # which will be relative to ego vehicle (rear center axle)
tx4_pos = [1, -0.07*2, 2] # which will be relative to ego vehicle (rear center axle)
...
ant_device_tx2 = add_single_tx(all_actors,waveform,mode_name,pos=tx2_pos,ffd_file='dipole.ffd',scale_pattern=10.0)
ant_device_tx3 = add_single_tx(all_actors,waveform,mode_name,pos=tx3_pos,ffd_file='dipole.ffd',scale_pattern=10.0)
ant_device_tx4 = add_single_tx(all_actors,waveform,mode_name,pos=tx4_pos,ffd_file='dipole.ffd',scale_pattern=10.0)
...
enable_coupling(mode_name,ant_device_tx4, heatmap.probe_device)
...
heatmap.update_heatmap_time_domain_3d(tx_mode=[ant_device_tx.modes[mode_name],ant_device_tx2.modes[mode_name],ant_device_tx3.modes[mode_name],ant_device_tx4.modes[mode_name]],
