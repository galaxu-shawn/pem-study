...
rx_pos = [20, 0, 1.5] # center of the grid. Because this example is creating 3D heatmap, z position doesn't matter
...
center_freq = 2.14e9
num_freqs = 2 # number of frequencies in the waveform
bandwidth = 10e6
cpi_duration = 0.9e-3
num_pulse_CPI = 2
...
city_name = all_actors.add_actor(filename=os.path.join(paths.models,'whole-scene-static.stl'),
...
# show_results_in_modeler=False, will not show the heatmap in the modeler, but will still calculate it,
# stored in heatmap.image_3d
...
# output_format can be 'point_cloud' 'contour' 'slice' or  'cut_plane' or 'contour_cut_plane'
heatmap.update_heatmap_3d(tx_mode=ant_device_tx.modes[mode_name],
...
# if show_results_in_modeler=False, then the heatmap can be accessed from heatmap.image_3d
